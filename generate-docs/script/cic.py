...
def generate_cic_pdf(data, output_path):
    values = {
        ...
        "*agence1": (data.agence1 or DEFAULTS["agence1"]).upper(),
        "*agence2": (data.agence2 or DEFAULTS["agence2"]).upper(),
        "*agenceadresse": (data.agenceadresse or DEFAULTS["agenceadresse"]).upper(),
        "*agencecpville": (data.agencecpville or DEFAULTS["agencecpville"]).upper(),
